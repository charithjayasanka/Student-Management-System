...
public class StuBelowAverage implements Comparable<StuBelowAverage>
{
    ...
    public StuBelowAverage(String regNo, String fName, String lName, int ict1mark, int ict2mark, int grpcw1mark, int grpcw2mark, int ovrModulemarks, Grade grade, boolean reSit, boolean reTake) {
        this.regNo = regNo;
        this.fName = fName;
        this.lName = lName;
    ...
    @Override
    public int compareTo(StuBelowAverage o) {
        return 0;
    }
}
